...
const authorManuscripts = ref<Manuscript[]>()
// For paginator
...
watch(manuscriptsRequest.data, (value) => {
    if (value) {
        ...
        authorManuscripts.value = stuff.content;
...
<template>
    <div class="authorManuscripts-wrapper">
        <div class="dataview-wrapper">
            <loader v-if="loading" />
            <DataView
                v-else
                :value="authorManuscripts"
                :layout="layout"
                data-key="id"
                :pt="{
                header: {
                    ...
                    <div class="flex w-full">
                        <div class="flex justify-content-start">
                            <h3 class="flex flex-column my-0 justify-content-around">
                                Manuskripter uploadet af {{ author?.name }}
                            </h3>
                        </div>
                        <div class="flex justify-content-end ml-auto">
                            <DataViewLayoutOptions
                                ...
                                :pt="{
                                    root: {
                                        style: 'border: 1px solid var(--surface-border); border-radius: 1.375rem; width: 9rem; height: 2.1rem; overflow: visible; display: flex; background-color: rgb(63, 63, 63);',
                                    },
                                    listButton: {
